...
public class RayCaster {
    ...
    private final double DR = 0.0174533;// 1 degree in radians
    ...
    public void drawRays3d(Graphics2D g2) {
        ...
        int distScale = 700; //how far away things look
        int px =( player.x - player.w / 2) *8;
        int py = (player.y - player.h / 2) *8;
        ...
        for (int r = 0; r < 2 * fov; r++) {
            ...
            if (ra < PI) {
                ry = (float) (py / tSize * tSize + renderDist);
                rx = (py - ry) * aTan + px;
                yo = tSize;
                xo = -yo * aTan;
            }
            ...
            if (ra < PI2 || ra > PI3) {
                rx = (float) (px / tSize * tSize + renderDist);
                ry = (px - rx) * nTan + py;
                xo = tSize;
                yo = -xo * nTan;
            }
